...
import 'package:repmusic/utilities/formatter.dart';
...
Future get10Music(dynamic playlistid) async {
  final List playlistSongs =
      await getData('cache', 'playlist30Songs$playlistid') ?? [];
  if (playlistSongs.isEmpty) {
    ...
    addOrUpdateData('cache', 'playlist30Songs$playlistid', playlistSongs);
  }
